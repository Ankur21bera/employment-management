...
const Leave = () => {
  ...
  try {
    await api.patch(`/leave/update-leaves/${id}`, { status });
  ...
  return (
    <div className='animate-fade-in'>
     <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8'>
      ...
      {!isAdmin && !isDeleted && (
        <button className='btn-primary flex items-center gap-2 w-full sm:w-auto justify-center cursor-pointer' onClick={()=>setShowModal(true)}>
