import { Form, Loader2Icon, LockIcon, X } from 'lucide-react';
     ...
     <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-fade-in' onClick={(e)=>e.stopPropagation()}>
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-5">
        ...
        <div className='flex gap-3 pt-2'>
         ...
         <button className='btn-primary flex-1 flex justify-center items-center gap-2 cursor-pointer' type='submit' disabled={loading}>
